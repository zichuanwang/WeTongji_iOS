...
+ (NSAttributedString *)generateContentAttributedStringWithNotificationObject:(InvitationNotification *)notification {
    ...
    if ([notification isKindOfClass:[ActivityInvitationNotification class]]) {
        ...
        result = [WTNotificationCourseInvitationCell generateNotificationContentAttributedStringWithSenderName:notification.sender.name courseTitle:courseInvitation.courseInfo.courseName accepted:notification.accepted.boolValue];
    }
    return result;
}
